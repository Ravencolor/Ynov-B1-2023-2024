...
getRandomPosition() renvoi une position aléatoire.

playAtPosition() joue à la position donnée en argument.

getPositionToPlay() renvoie la position à jouer la plus adaptée.

play() gère la mécanique de jeu de l'IA.

hasTwoCentralPositions() renvoi True si l'opposant a deux positions centrales consécutives ou False sinon.

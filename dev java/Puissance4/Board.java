...
initializeGrid() rempli la grille de jeu de Symbol.VIDE qui est un point. 

isColumnFull() renvoi True si la colonne passé en paramètre est pleine ou False sinon. 

getEmptyPositionForColumn() renvoi une Position disponible pour la colonne passé en paramètre.

setSymbolAtPosition() attribut le symbol passé en paramètre à la position de la grille passé en paramètre. 
*/

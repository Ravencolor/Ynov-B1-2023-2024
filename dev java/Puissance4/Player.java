/* 
La classe Player contient le nom du joueur, son nombre de jetons restant, les positions des jetons qu'il a joués et le symbole qu'il lui a été affecté:

playAtColumn() joue sur la colonne passé en paramètre.

hasWin() renvoi True si le joueur a quatre jeton alignés ou False sinon.

isPositionWinnable() renvoi True si une position peut remporter la victoire.

getConsecutivePositions() renvoi une HashMap avec pour clef la direction et pour valeur une liste de listes de positions consécutives.

decrementNumOfCoin() décrément le nombre de jetons du joueur.
